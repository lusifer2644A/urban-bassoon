  ...
  return (
    <>
      ...
      <main className="bg-light dark:bg-dark overflow-x-hidden">
        ...
        <header className="hero-bg-light-background dark:hero-bg-dark-background min-h-screen">
          <div className="">
            <Header />
          </div>
          <div className="container pt-40 xl:pt-60 pb-20 md:pb-40 xl:pb-48">
            <motion.div className="grid-2x2 justify-start">
              <div className="w-full md:w-2/4 max-w-xl">
                <div className="flex flex-col items-start justify-start gap-2 md:gap-4">
                  <motion.h1
                    ...
                    className="heading font-bold text-dark-1 dark:text-light-1"
                  >
                    {data.hero.title}
                  </motion.h1>
                  <motion.h2
                    ...
                    className="sub-heading text-dark-2 dark:text-light-2"
                  >
                    {data.hero.subtitle}
                  </motion.h2>
                  <motion.div
                    ...
                    {/* <div>
                      ...
                      >
                        <circle
                          ...
                          cy="50"
                          r="49.5"
                          className=" stroke-dark-1 dark:stroke-light-1"
                        />
                        <path
                          d="M40.75 33.25L65.25 49L40.75 64.75V33.25Z"
                          fill="#1D1125"
                          className="fill-dark-1 dark:fill-light-1 stroke-dark-1 dark:stroke-light-1"
                        />
                      </svg>
                    </div> */}
                    <ContainedButton path="/connect/seller">
                      Get Started
                    </ContainedButton>
                  </motion.div>
                </div>
        ...
        {/* CTA Section */}
        <div className="px-4 sm:px-6 lg:px-8 xl:px-10 mx-auto my-0 md:my-0">
          <motion.div
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
            className="flex flex-col md:flex-row-reverse justify-center items-center mx-auto gap-4 md:gap-32 lg:gap-56 xl:gap-72 md:pt-0"
          >
            <div className="w-full md:w-2/4 flex flex-col items-start justify-start gap-2 md:gap-4 max-w-lg">
              <div className="w-full ">
                <h2 className="heading-2 headingColor2 text-center md:text-left">
                  Vision:
                </h2>

                <h2 className="body-1 text-dark-3 dark:text-light-2 pt-0 text-center md:text-left">
                  Redefining global selling
                </h2>
              </div>
              <div className="w-full">
                <h2 className="heading-2 headingColor2 mt-6 text-center md:text-left">
                  Mission:
                </h2>
                <h2 className="body-1 text-dark-3 dark:text-light-2 text-center md:text-left">
                  Simplify and maximize the global potential for every Indian
                  seller
                </h2>
              </div>
              <KnowMore path="/about" className="text-center md:text-left">
                Know More
              </KnowMore>
            </div>
            <div className=" w-full h-full md:w-fit relative">
              <div className="flex items-center justify-center mx-auto  ">
                <Image
                  className="w-auto h-96 md:h-72 lg:h-[36rem] object-cover"
                  src={`/asset/hero/${data.cta.image}`}
                  alt="hero image"
                  loading="lazy"
                  width="2000"
                  height="2000"
        ...
        {/* Features */}
        <div className="px-4 sm:px-6 lg:px-8 xl:px-10 mx-auto pt-20 md:pt-32">
          <div
            className="heading headingColor2 text-center "
            style={{
              fontWeight: "600",
            }}
          >
          ...
          <div className="sub-heading-2 font-normal headingColor  text-center pt-0 ">
            {data.features.title}
          </div>
          <div className="px-4 md:px-8 xl:px-40 py-2 md:py-8">
            {data.features.list.map((item, index) => (
              <div
                ...
                } justify-center items-center mx-auto gap-4 md:gap-32 lg:gap-56 xl:gap-72 py-12 md:py-20 `}
              >
                <div className="w-full md:w-2/4 max-w-lg flex flex-col items-start justify-start gap-4 mt-10 md:mt-0">
                  <h2 className="heading-2 text-dark-1 dark:text-light-2">
                    {item.title}
                  </h2>
        ...
        <div className="container pt-20  md:pt-40">
          ...
          <div className="sub-heading-2 font-normal headingColor  text-center  ">
            {data.product.title}
          </div>
          <div className="flex flex-col md:flex-row justify-center items-center mx-auto  gap-20 md:gap-20 h-full w-full  pt-16">
            {data.product.list.map((item, index) => (
              <div key={index}>
                <div className="flex flex-col gap-2 justify-center items-center w-full h-full ">
                  ...
                  <div className="w-full h-full">
                    <h2 className="subtitle-3 h-20 flex items-center justify-center   text-center w-48 mx-auto text-dark-1 dark:text-light-2">
                      {item.title}
                    </h2>
                  </div>
                  <div>
                    <RoundedButton path={item.link}>Know More</RoundedButton>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container  pt-20  md:pt-40">
          ...
          <div className="body-2 headingColor max-w-2xl mx-auto text-center py-6 pb-4 md:pb-8 md:pt-8">
            If you have a desire to take your brand global, we have a program
            for you
          </div>
          <div className="flex flex-row flex-wrap gap-12 justify-center items-center py-5 px-8">
            {data.service.list.map((item, index) => (
              <div
                key={index}
                className={
                  `flex flex-col gap-4  items-center border-2 border-transparent h-72 w-80 bg-white rounded-xl px-4 py-4 shadow-lg ` +
                  (index === -1
              ...
              >
                ...
                <div>
                  <h3 className="sub-heading-3 text-center text-dark-1 mt-5">
                    {item.title}
                  </h3>
                  <h2 className="body-3 text-center text-dark-2 mt-1">
                    {item.subTitle}
                  </h2>
                </div>
              </div>
          ...
          <div className="w-full flex items-center justify-center pt-12">
            <RoundedButton path="/service">Know More</RoundedButton>
          </div>
        </div>
        ...
        <div className="container pt-20 md:pt-40">
          ...
          <div className="flex flex-col md:flex-row justify-center items-start pt-12 md:pt-20 gap-12 md:gap-24 px-4">
            <div className="md:w-2/4">
              <div className="flex flex-row gap-2 md:gap-0 items-start justify-start">
                ...
                <div className="w-10/12 flex flex-col  items-start justify-start gap-2">
                  <div className="sub-heading-2 headingColor-2">
                    {data.integrations.list[0].title}
                  </div>
                  <div className="body-2 text-start  headingColor max-w-lg">
                    {data.integrations.list[0].body}
                  </div>
                </div>
              </div>
            </div>
            <div className="md:w-2/4">
              <div className="flex flex-row gap-2 md:gap-0 items-start justify-start">
                ...
                <div className="w-10/12 flex flex-col  items-start justify-start gap-2">
                  <div className="sub-heading-2 headingColor-2">
                    {data.integrations.list[1].title}
                  </div>
                  <div className="body-2 text-left  headingColor max-w-lg">
                    {data.integrations.list[1].body}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container pt-20 md:pt-40 ">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-center items-center mx-auto gap-2 md:gap-8 pt-8 px-4">
            <div className="w-full md:w-2/4 flex flex-col items-center md:items-start justify-start gap-4">
              ...
              <div>
                ...
                >
                  <Link href="/openposition">
                    <div className="px-6 py-2 accent-grad text-center  rounded-lg cursor-pointer">
                      <div className="flex flex-row items-center justify-center gap-2 text-dark-1 text-center">
                        <div>Join Us </div>
                        <div>
                          <div>
                            <svg
                            ...
                            >
                              ...
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M10.9507 7.80162C10.5275 7.39952 9.85126 7.3994 9.42799 7.80162ZM10.9507 7.80162L14.5714 11.2414C14.7869 11.4463 14.8996 11.7211 14.8996 11.9999C14.8996 12.2789 14.7868 12.5538 14.5713 12.7585L10.9507 16.1982C10.5275 16.6004 9.85116 16.6006 9.42789 16.1983C8.99019 15.7825 8.99017 15.097 9.4279 14.6811L12.2501 11.9999L9.42799 9.31888C8.99045 8.90301 8.99031 8.21752 9.42799 7.80162"
                                className="fill-dark-1  "
                              />
                              <path
                                fill-rule="evenodd"
                              ...
                              <defs>
                                ...
                                <radialGradient
                                  id="paint1_radial_456_4894"
                                  cx="0"
                                  cy="0"
                                  r="1"
                                  gradientUnits="userSpaceOnUse"
                                  gradientTransform="translate(12 0.969279) rotate(90) scale(2.56403 17.4209)"
                                >
                                  <stop offset="0.3" stop-color="#692E98" />
                                  <stop
                                    offset="1"
                                    stop-color="#692E98"
                                    stop-opacity="0"
                                ...
                                <radialGradient
                                  id="paint2_radial_456_4894"
                                  cx="0"
                                  cy="0"
                                  r="1"
                                  gradientUnits="userSpaceOnUse"
                                  gradientTransform="translate(11.3763 16.1852) rotate(16.9432) scale(10.3038 4.57031)"
                                >
                                  <stop stop-color="#692E98" />
                                  <stop
                                    offset="1"
                                    stop-color="#692E98"
                                    stop-opacity="0"
                                ...
                                <radialGradient
                                  id="paint4_radial_456_4894"
                                  cx="0"
                                  cy="0"
                                  r="1"
                                  gradientUnits="userSpaceOnUse"
                                  gradientTransform="translate(11.9996 7.86348) rotate(90) scale(0.961507 4.21004)"
                                >
                                  <stop offset="0.3" stop-color="#692E98" />
                                  <stop
                                    offset="1"
                                ...
                                <radialGradient
                                  id="paint5_radial_456_4894"
                                  cx="0"
                                  cy="0"
                                  r="1"
                                  gradientUnits="userSpaceOnUse"
                                  gradientTransform="translate(11.8489 13.5694) rotate(25.3012) scale(2.63473 1.61976)"
                                >
                                  <stop stop-color="#692E98" />
                                  <stop
                                    offset="1"
