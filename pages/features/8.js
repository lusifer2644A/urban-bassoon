...
export default function Index() {
  ...
  const data = {
    ...
    heroQues:
      "Wish to get paid in multiple currencies at the best rates in your local bank account? ",
    description:
      "Fast-track your business with our Global Payments offerings to support all your financing and payment needs to grow globally.",
    ...
    list: [
      {
        ...
        title: "Lowest Rates        ",
        description:
          "Making or receiving international funds, and managing your digital business has never been easier with the lowest commission on international payments",
      },
      {
        id: 2,
        image: "08-02.svg",
        title: "Minimise Risk",
        description:
          "Protect your business from unpredictable losses at minimal costs with international goods transit insurance",
      },
      {
        id: 3,
        image: "08-03.svg",
