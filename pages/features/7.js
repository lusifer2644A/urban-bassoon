...
export default function Index() {
  ...
  const data = {
    ...
    heroQues:
      "Want stress-free adherence to international compliances to mitigate any risks and losses?",
    description:
      "Don't be bothered about international trade compliances with our Trade Compliance services for smooth and risk-free sales. Get unlimited knowledge from our trade experts while managing all your registrations, certifications, and automated operations with our tools.",
    ...
    list: [
      {
        ...
        title: "Landed Cost",
        description:
          "Automated invoice generation and landed cost calculation with foreign VATs and duties ",
      },
      {
        id: 2,
        image: "07-02.svg",
        title: "Single POC        ",
        description:
          "Single knowledge hub for all international customs, licenses, restrictions, permits, and IOR services",
      },
      {
        id: 3,
        image: "07-03.svg",
