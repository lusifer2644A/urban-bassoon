...
export default function Index() {
  ...
  const data = {
    ...
    heroQues: "Want to catalyze your business with new customer acquisition?",
    description:
      "Choose from a range of service packages and let an e-commerce expert cater to all your cataloging, marketing, web store, and all your pre-selling needs",
    ...
    list: [
      {
        ...
        title: "One Stop Shop",
        description:
          "Browse through services that can propel your e-commerce business",
      },
      {
        id: 2,
        image: "04-02.svg",
        ...
        description:
          "Local country experts to customize offerings as per target regions",
      },
      {
        id: 3,
        image: "04-03.svg",
        ...
        description:
          "Seamless access, connection, and transaction in the most digitized way",
      },
    ],
  };
