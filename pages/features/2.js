...
export default function Index() {
  ...
  const data = {
    ...
    heroQues:
      "Looking to turbocharge your existing online stores for entry into new markets? ",
    description:
      "Our goGlocal Store simplifies your global expansion journey by modifying your existing online stores and listings in accordance with the foreign country’s customer needs.       ",
    serviceTitle: "Catalyze new country entry with",
    ...
    list: [
      {
        ...
        description:
          "Tailor your brand offerings to be compatible with local requirements using highly reliable translations",
      },
      {
        id: 2,
        image: "02-02.svg",
      ...
      },
      {
        ...
        description:
          "Efficient operations with products, orders, deliveries, and payment management in a few clicks",
      },
    ],
  };
