...
export default function Index() {
  ...
  const data = {
    ...
    description:
      "Plug-in to a huge pool of new customers from around the globe with our Marketplace Connect. Our platform enables you to sell your products to anyone, anywhere, anytime. Supercharge your e-commerce sales with our channel partners and analytical tools.",
    ...
    list: [
      {
        ...
        description:
          "Develop marketplace-specific curated product offerings with analytics to maximize sales",
      },
      {
        id: 2,
        image: "03-02.svg",
